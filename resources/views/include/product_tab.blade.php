                    ...
                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                        <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                            ...
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="shop-product-right.html">
                                        <img class="default-img"
                                            src="{{ asset('uploads/product/'.$newproduct->image) }}"
                                            alt="" />
                                        <img class="hover-img"
                                            src="{{ asset('uploads/product/'.$newproduct->image) }}"
                                            alt="" />
                                ...
                                <div class="product-action-1">
                                    ...
                                    <a aria-label="Quick view" class="action-btn" data-bs-toggle="modal"
                                        data-bs-target="#quickViewModalNew{{$newproduct->id}}"><i class="fi-rs-eye"></i></a>
                                </div>
                            ...
                            <div class="product-content-wrap">
                                ...
                                <h2><a href="#">{{$newproduct->product_name}}</a></h2>
                                ...
                                <div>
                                    <span class="font-small text-muted">By <a
                                            href="#">{{$newproduct->user->name}}</a></span>
                                </div>
                                <div class="product-card-bottom">
                                    <div class="product-price">
                                        <span>${{$newproduct->discount_price}}</span>
                                        <span class="old-price">${{$newproduct->selling_price}}</span>
                                    </div>
                                    <div class="add-cart">
