                        ...
                        <div class="header-action-2">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <form action="{{ route('logout') }}" method="post">
                                                    @csrf
                                                    <button><i class="fi fi-rs-sign-out mr-10"
                                                            onclick="return confirm('Are You Sure You Want To Logout This Dashboard?');"></i>Sign
                                                        out</button>
                                                    </button>
                                                </form>
                                            </li>
                            ...
                            @else
                                <div class="header-action-icon-2">
                                    <a href="#">
                                        <img class="svgInject" alt="Nest"
                                            src="{{ asset('frontend') }}/assets/imgs/theme/icons/log.png" />
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="shop-grid-right.html"> <img
                                            src="{{ asset('uploads/category/'.$category->cat_image) }}"
