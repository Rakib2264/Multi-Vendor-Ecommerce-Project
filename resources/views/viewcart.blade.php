                        ...
                        <table class="table table-wishlist">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td class="image product-thumbnail"><img src="{{asset('uploads/product/'.$cartItem->image)}}"
                                        alt="#"></td>
                                <td class="product-des product-name">
                                    <h6 class="mb-5"><a class="product-name mb-10 text-heading"
                                            href="shop-product-right.html">{{$cartItem->product_name}}</a></h6>
                                ...
                                <td class="price" data-title="Price">
                                    <h4 class="text-brand">${{$cartItem->price}} </h4>
                                </td>
                                <td class="action text-center delete-item">
                                    <button class='delete-item' value="{{ $cartItem->id }}">
