...
@endif
                          <form action="{{route('admin.updatepassword')}}" method="post">
                            ...
                            <div class="mb-2 mt-5 p-0">
                                ...
                                <input type="text" name="opas" class="form-control" placeholder="Enter old password">
                            </div>
                            <div class="mb-2 ">
                                <label class="form-label">New Password</label>
                                <input type="text" name="npas" class="form-control" placeholder="Enter new password">
                            </div>
                            <div class="mb-2">
                                <label class="form-label">Confirm Password</label>
                                <input type="text" name="cpas" class="form-control" placeholder="Confirm password">
                            </div>
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-primary">Change Password</button> <a href="{{route('admin.dashboard')}}" class="btn btn-light"><i class="bx bx-arrow-back mr-1"></i>Back to Login</a>
                            </div>
                          </form>
                        </div>
                    </div>
